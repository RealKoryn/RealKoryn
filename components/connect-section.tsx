        ...
        <div className="text-center space-y-8">
          ...
          >
            <Button size="lg" className="gap-2" asChild>
              <a href="https://discord.com/users/1068287365182931066" target="_blank" rel="noopener noreferrer">
          ...
          >
            <a
              href="https://www.youtube.com/@RealKoryn"
              target="_blank"
            ...
            <a
              href="https://github.com/RealKoryn"
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 hover:bg-muted rounded-lg transition-colors"
              aria-label="GitHub"
            ...
            <a
              href="https://discord.com/users/1068287365182931066"
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 hover:bg-muted rounded-lg transition-colors"
              aria-label="Discord"
